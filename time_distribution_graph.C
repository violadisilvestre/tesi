...
int main() {
    std::vector<std::string> filenames = {
        ...
        "T_smear_4000.txt","T_smear_119.txt","T_smear_723.txt","T_smear_29824.txt","T_smear_528.txt","T_smear_648.txt","T_smear_26539.txt","T_smear_135.txt",
	"T_smear_150.txt" ,"T_smear_700.txt","T_smear_800.txt"  };
    ...
    TF1 *fit_low = new TF1("fit_low", "[0]+[1]*x+[2]*x**2+[3]*x**4", 0, 20); // Fitting con un polinomio di secondo grado
    TF1 *fit_high = new TF1("fit_high", "[0]+[1]*x+[2]*x**2+[3]*x**4", 0, 20);
