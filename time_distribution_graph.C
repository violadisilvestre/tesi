...
int main() {
  std::vector<std::string> filenames = { "T_smear_0.txt", "T_smear_1.txt", "T_smear_2.txt", "T_smear_3.txt","T_smear_4.txt", "T_smear_5.txt", "T_smear_6.txt", "T_smear_9.txt","T_smear_12.txt", "T_smear_14.txt"
  //};
