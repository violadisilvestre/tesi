...
int main() {
  ...
  std::vector<std::string> filenames = { "T_smear_1.txt","T_smear_2.txt","T_smear_3.txt","T_smear_5.txt", "T_smear_6.txt", "T_smear_9.txt", "T_smear_14.txt", "T_smear_15.txt","T_smear_16.txt","T_smear_18.txt"
        };
    ...
    c1->SaveAs("N_vs_ToT_fit_cell2.png");
