...
int main() {
    std::vector<std::string> filenames = {
        ...
        "T_smear_4000.txt","T_smear_119.txt","T_smear_325.txt","T_smear_723.txt","T_smear_29824.txt","T_smear_12392.txt","T_smear_325.txt","T_smear_207.txt","T_smear_528.txt","T_smear_648.txt","T_smear_26539.txt","T_smear_71004.txt",
    };
