...
int main() {
    ...
    TH1F* sumHistogram = new TH1F("sumHistogram", "Sum of Normalized Histograms", 20, 58, 80);
    ...
    for (int i = 0; i < time.size(); ++i) {
        double mean = time[i];
        TH1F* histogram = new TH1F("histogram", "Normalized Histogram", 20, 58, 80);
    ...
    TH1F* realHistogram = new TH1F("realHistogram", "Time Distribution", 20, 58, 80);
